...
=========================
Ist ein Code-Snippet für das CMS LEPTON.
Alle, für die Erzeugung des Menüs erforderlichen Daten, werden durch eine einzige 
...
modifiziert werden, an denen das Menü erscheinen soll.
...
A:  Im verwendeten Template fehlen die notwendigen Zeilen:
    ...
    1.  Im LEPTON Admin Backend: Optionen -> Erweiterte Optionen anzeigen ->        
...
$aItemOpen
    ...
    '[li][a][menu_title]</a>' verwendet um die Kompatibilität zur LEPTON
