...
if(defined('WB_URL'))
{
  ...
  // first copy content of original news_tables to sik_tables	
  $database->query("DROP TABLE IF EXISTS `".TABLE_PREFIX."sik_news_posts`");
  $database->query("RENAME TABLE `".TABLE_PREFIX."mod_news_posts` TO `".TABLE_PREFIX."sik_news_posts`"); 

  $database->query("DROP TABLE IF EXISTS `".TABLE_PREFIX."sik_news_groups`");
  $database->query("RENAME TABLE `".TABLE_PREFIX."mod_news_groups` TO `".TABLE_PREFIX."sik_news_groups`");    
  
  $database->query("DROP TABLE IF EXISTS `".TABLE_PREFIX."sik_news_comments`");
  $database->query("RENAME TABLE `".TABLE_PREFIX."mod_news_comments` TO `".TABLE_PREFIX."sik_news_comments`");    
  
  $database->query("DROP TABLE IF EXISTS `".TABLE_PREFIX."sik_news_settings`");
  $database->query("RENAME TABLE `".TABLE_PREFIX."mod_news_settings` TO `".TABLE_PREFIX."sik_news_settings`");     
 ...
 $database->query("INSERT INTO `".TABLE_PREFIX."mod_news_posts` SELECT * FROM `".TABLE_PREFIX."sik_news_posts`");   
 $database->query("INSERT INTO `".TABLE_PREFIX."mod_news_groups` SELECT * FROM `".TABLE_PREFIX."sik_news_groups`");   
 $database->query("INSERT INTO `".TABLE_PREFIX."mod_news_comments` SELECT * FROM `".TABLE_PREFIX."sik_news_comments`");   
 $database->query("INSERT INTO `".TABLE_PREFIX."mod_news_settings` SELECT * FROM `".TABLE_PREFIX."sik_news_settings`");      
