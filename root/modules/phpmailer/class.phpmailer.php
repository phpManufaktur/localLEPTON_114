 ...
 */
  ...
  */
  function SetLanguage($langcode = 'en', $lang_path = 'language/') {
    ...
    $l = true;
    /**
     * @todo the autoselection of languages with the $langcode wont work at any 
     * installation and throws a hard error. As workaround the language is 
     * reduced to the hardcoded english language above
     *    
