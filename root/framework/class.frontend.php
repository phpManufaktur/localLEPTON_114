 ...
 * @version         $Id: class.frontend.php 1172 2011-10-04 15:26:26Z frankh $
 *
 */
...
class frontend extends wb {
	...
	public function register_frontend_modfiles() {
		 ...
		 *	droplet patch
		 */
		$droplet_js = WB_PATH."/modules/droplets/js/mdcr.js";
		if (file_exists($droplet_js))
		$html .= "<script src=\"".WB_URL."/modules/droplets/js/mdcr.js\" type=\"text/javascript\"></script>\n";
		unset($droplet_js);
		...
		$test_path = WB_PATH."/modules/register_modfiles/classes/c_register_modfiles.php";
