 ...
 * @version         $Id: addon.precheck.inc.php 1172 2011-10-04 15:26:26Z frankh $
 *
 */
...
function sortPreCheckArray($precheck_array)
{
	...
	$key_order = array('LEPTON_VERSION', 'WB_VERSION', 'WB_ADDONS', 'PHP_VERSION', 'PHP_EXTENSIONS', 'PHP_SETTINGS', 'CUSTOM_CHECKS');
