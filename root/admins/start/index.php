 ...
 * @version         $Id: index.php 1710 2012-01-26 16:57:33Z frankh $
 *
 */
...
$warning = (ini_get('register_globals')) ? 'This PHP installation is insecure because register_globals is on!' : '';
...
$tpl->set_block('main_block', 'show_install_block', 'show_install');
...
if (file_exists(WB_PATH.'/install/')) {
	...
	if( in_array (1, $admin->get_groups_id() ) )
	{
		...
		$tpl->parse('show_install', 'show_install_block', true);
	}
} else {
	$tpl->parse('show_install', 'show_install_block', true);
}

if (($warning == '') || !in_array (1, $admin->get_groups_id()) ) {
